...
> [!QUESTION]- Practice Questions — for contemplation after reading
> 1. **DN 22 vs MN 10**: DN 22 adds a full treatment of the Four Noble Truths to the Dhammānupassanā section. Read the Truths section (§§ on *dukkhasacca*, *samudayasacca*, *nirodhasacca*, *maggasacca*). How does placing the Noble Truths inside a mindfulness sutta change their feel — from doctrine to direct perception?
> 2. **The five hindrances section**: The sutta lists hindrances with a precise formula — knowing when each is present, knowing when it is absent, knowing how the absent one arises, knowing how the arisen one is abandoned. Try this framework in your next sit: for one hindrance, can you track all four of these knowings?
> 3. **The seven awakening factors section**: The sutta says one knows when an awakening factor is present or absent and knows how an absent factor is cultivated. Which awakening factor do you find easiest to recognise when it is arising in meditation?
> 4. **The refrain across foundations**: The three-part refrain (internal/external/both; arising/passing/both; bare knowing) applies to every foundation. Pick one foundation and sit with *only* the temporal dimension: what is arising right now, what is passing, what is doing both?
> 5. **The promise**: The sutta says this path leads to "the direct realisation of final Nibbāna" if maintained for seven years, seven months, or — for a sharp-faceted practitioner — seven days. What does it mean to "not deviate" from satipaṭṭhāna for a full day?
