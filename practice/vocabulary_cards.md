...
[[INDEX|Dashboard]] > [[topics/topics|Topics Hub]] > [[topics/texts/texts|Texts & Canon]] > [[topics/texts/pali-canon/Texts-Index|Pāḷi Canon]] > Pāḷi Vocabulary Flashcards
...
natthi :: [pr] is not; it is not; there is not; there is no; there is nothing
vutta :: [pp] sown; scattered; planted
sukha :: [adj] easy (on); comfortable (for); pleasant (for); good (for); contented
...
paṭicca :: [ger] dependent; depending (on); contingent (upon); relying (on); because (of); supported (by); on account...
assa :: [masc] horse
...
caparaṁ :: [sandhi] and further; and what is more
tiṭṭhati :: [pr] stands
ayampi :: [sandhi] one too; this too
seyyathidaṁ :: [sandhi] i.e.; as follows
dvi :: [card] two (2)
...
anuttara :: [adj] highest (of); unsurpassed (by); incomparable (to); superior (to)
...
pahāna :: [nt] giving up (of); letting go (of); removal (of); abandoning (of)
