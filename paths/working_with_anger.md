---
id: working_with_anger
title: "Working with Anger and Ill Will: A Reading Path"
type: path
tags:
  - aversion
  - ill-will
...
```mermaid
graph TD
    A["Recognition <br> (MN 10 / DN 22)"] --> B["Methods for Removal <br> (MN 20)"]
    B --> C["Purifying the Heart <br> (MN 7)"]
    C --> D["Awakening Factors as Antidote <br> (SN 46)"]
    D --> E["Eleven Benefits of Mettā <br> (AN 11.15)"]
    E --> F["Mettā in Practice <br> (Snp 1.8)"]
